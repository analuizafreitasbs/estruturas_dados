...
import Filas.Fila_Dinamica.src.Enfileiravel;
import Filas.Fila_Dinamica.src.FilaDinamica;
...
public class FilaDInamicaTeste {
  ...
  public void testFilaComDiferentesTipos() {
    ...
    Enfileiravel<Double> filaDouble = new FilaDinamica<>(2);
  ...
  public void testConstrutorPadrao() {
    Enfileiravel<String> fila = new FilaDinamica<>();
  ...
  public void testConstrutorComTamanhoPersonalizado() {
    Enfileiravel<String> fila = new FilaDinamica<>(5);
  ...
  public void testEnfileirar() {
    Enfileiravel<String> fila = new FilaDinamica<>(1);
  ...
  public void testEnfileirarMultiplosElementos() {
    Enfileiravel<String> fila = new FilaDinamica<>(3);
      fila.enfileirarFim("A");
      fila.enfileirarFim("B");
      fila.enfileirarFim("C");
      assertEquals("A", fila.frente());
      assertEquals("[A,B,C]", fila.imprimirFrentePraTras());
  }
  ...
  public void testImprimirDeFrentePraTras() {
    ...
    String resultado = fila.imprimirFrentePraTras();
  ...
  public void testImprimirDeFrentePraTrasVaziaFormatacaoVazia() {
    Enfileiravel<String> fila = new FilaDinamica<>(2);
    assertEquals("[]", fila.imprimirFrentePraTras());
  }
