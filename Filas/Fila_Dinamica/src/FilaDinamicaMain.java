...
/**
 * Classe principal para execução de operações na Fila Dinâmica.
 * Essa classe demonstra a criação e manipulação de uma fila dinâmica,
 * utilizando as operações de enfileirarFim, desenfileirarInicio e exibir o conteúdo
 * da fila.
 *
 * @author Ana Luiza
 * @version 1.0
            ...
            try {
                ...
                switch (opcao) {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        System.out.println(fila.imprimirFrentePraTras());
                        break;
                    default:
